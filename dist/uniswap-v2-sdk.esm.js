...
(function (ChainId) {
  ...
  ChainId[ChainId["LATESTNET"] = 418] = "LATESTNET";
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB, _FACTORY_ADDRESS, _INIT_CODE_HASH) {
    if (_FACTORY_ADDRESS === void 0) {
      _FACTORY_ADDRESS = FACTORY_ADDRESS;
    }
    if (_INIT_CODE_HASH === void 0) {
      _INIT_CODE_HASH = INIT_CODE_HASH;
    }
    var tokenAmounts = tokenAmountA.token.sortsBefore(tokenAmountB.token) // does safety checks
    ? [tokenAmountA, tokenAmountB] : [tokenAmountB, tokenAmountA];
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, _FACTORY_ADDRESS, _INIT_CODE_HASH), 18, 'UNI-V2', 'Uniswap V2');
    this.tokenAmounts = tokenAmounts;
  }
  Pair.getAddress = function getAddress(tokenA, tokenB, _FACTORY_ADDRESS, _INIT_CODE_HASH) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE$t = _PAIR_ADDRESS_CACHE[tokens[0].address]) === null || _PAIR_ADDRESS_CACHE$t === void 0 ? void 0 : _PAIR_ADDRESS_CACHE$t[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE2 = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE2 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE2[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = getCreate2Address(_FACTORY_ADDRESS, keccak256(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), _INIT_CODE_HASH), _extends2)), _extends3));
    }
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount, _FACTORY_ADDRESS, _INIT_CODE_HASH) {
    if (_FACTORY_ADDRESS === void 0) {
      _FACTORY_ADDRESS = FACTORY_ADDRESS;
    }
    if (_INIT_CODE_HASH === void 0) {
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount, _FACTORY_ADDRESS, _INIT_CODE_HASH) {
    if (_FACTORY_ADDRESS === void 0) {
      _FACTORY_ADDRESS = FACTORY_ADDRESS;
    }
    if (_INIT_CODE_HASH === void 0) {
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType, _FACTORY_ADDRESS, _INIT_CODE_HASH) {
    if (_FACTORY_ADDRESS === void 0) {
      _FACTORY_ADDRESS = FACTORY_ADDRESS;
    }
    if (_INIT_CODE_HASH === void 0) {
    ...
    if (tradeType === TradeType.EXACT_INPUT) {
      ...
      for (var i = 0; i < route.path.length - 1; i++) {
        ...
        var _pair$getOutputAmount = pair.getOutputAmount(amounts[i], _FACTORY_ADDRESS, _INIT_CODE_HASH),
      ...
      for (var _i = route.path.length - 1; _i > 0; _i--) {
        ...
        var _pair$getInputAmount = _pair.getInputAmount(amounts[_i], _FACTORY_ADDRESS, _INIT_CODE_HASH),
  ...
  // used in recursion.
  currentPairs, originalAmountIn, bestTrades, _FACTORY_ADDRESS, _INIT_CODE_HASH) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      try {
        ;
        var _pair$getOutputAmount2 = pair.getOutputAmount(amountIn, _FACTORY_ADDRESS, _INIT_CODE_HASH);
  ...
  // used in recursion.
  currentPairs, originalAmountOut, bestTrades, _FACTORY_ADDRESS, _INIT_CODE_HASH) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      try {
        ;
        var _pair$getInputAmount2 = pair.getInputAmount(amountOut, _FACTORY_ADDRESS, _INIT_CODE_HASH);
      ...
      if (amountIn.token.equals(tokenIn)) {
        ...
        Trade.bestTradeExactOut(pairsExcludingThisPair, currencyIn, amountIn, {
          maxNumResults: maxNumResults,
          maxHops: maxHops - 1
        }, [pair].concat(currentPairs), originalAmountOut, bestTrades, _FACTORY_ADDRESS, _INIT_CODE_HASH);
      }
    }
    return bestTrades;
  };
...
var Fetcher = /*#__PURE__*/function () {
   ...
   */
  ;
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider, _FACTORY_ADDRESS, _INIT_CODE_HASH) {
    if (_FACTORY_ADDRESS === void 0) {
      _FACTORY_ADDRESS = FACTORY_ADDRESS;
    }
    if (_INIT_CODE_HASH === void 0) {
    ...
    try {
      ...
      var address = Pair.getAddress(tokenA, tokenB, _FACTORY_ADDRESS, _INIT_CODE_HASH);
...
var WETH9 = {
	...
	"222": "0x5104378141488F3ABC32D8d80071627F95591F85",
	"418": "0x0512E93039a469Ef0D0140Dd0f5C6C7F90e61e16",
	"84531": "0xF2449390431c20D7e8b295AC654293eb38a38bC2"
};
var UniswapV2Factory = {
	"1": "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f",
	"5": "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f",
	"222": "0xf74D4a71a3a5bD040a960fff79e5f3513a579F4d",
	"418": "0x885718412E845ee01F3fE21Fc36da740A38ebf58",
	"84531": "0x6AA58bBDF51F4f78eF1041C1654A584fb92C7772"
};
var Multicall = {
	"1": "0xeefBa1e63905eF1D7ACbA5a8513c70307C1cE441",
	"5": "0xcA11bde05977b3631167028862bE2a173976CA11",
	"222": "0xF742f27dcb773a43533B94769C950b2CA9B16D8B",
	"418": "0x3bc056460718593307B37945c111dBedf884ff22",
	"84531": "0xe035578413212cF99e705f54ED5ed1d32052024D"
};
var INIT_CODE_HASH$1 = {
	"1": "96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f",
	"5": "96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f",
	"222": "6b5a6e78489e855baf2de593a4de0067eb5445636c1325f795859066de6b03d5",
	"418": "6b5a6e78489e855baf2de593a4de0067eb5445636c1325f795859066de6b03d5",
	"84531": "6b5a6e78489e855baf2de593a4de0067eb5445636c1325f795859066de6b03d5"
};
var Multicall3 = {
	"1": "0xcA11bde05977b3631167028862bE2a173976CA11",
	"5": "0xcA11bde05977b3631167028862bE2a173976CA11",
	"222": "0x64b370515F9B2AAcE175fF3097129495337f61B9",
	"418": "0xf96410524B43913602E75CCC14d3dC611019ee24",
	"84531": "0xb3f5BF914DAc3e0E532c99049b87115A9773b77c"
};
var UniswapV2Router02 = {
	"1": "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D",
	"5": "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D",
	"222": "0x799a6E72A0D5233c92D1bC92E960F939a654e872",
	"418": "0x584A3e364313B0d133A1925f2c1fDfB6dd5E9BEA",
	"84531": "0x81845Fa9817d06aCC304eB01EB707cECA21b9cae"
};
var Staking = {
	"5": "0xebB86F1F3825b4e255d444aa9b1AA4fbfa92cB7f",
	"222": "0x45c4fDa7bbb5Ea233a070AcA95980c07fEF1a6F3",
	"418": "0x85593C91853f1705D474A9158393A807F90ba3CE",
	"84531": "0xe0936d7C329338D6Ef12BaDB28251A0e8E1778A1"
};
